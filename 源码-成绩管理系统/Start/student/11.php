...
$query_cj_rank = "select 课程号,课程名,学分,成绩,排名 from( select 课程号,课程名,学分,成绩,@currank := @currank+1 as 排名 from  (select 课程号,kc.课程名,cj.学分,成绩 from cj join kc using(课程号) where 课程名='$_kcm' order by 成绩 desc) a join (select @currank := 0 ) q ) b";
...
<div id="search">
    ...
    <form id="kc_search" name="kc_search" method="get" action="11.php">
      <p>
        ...
        <input type="submit" name="submit" id="submit" value="点击搜索" />
